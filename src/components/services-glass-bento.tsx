...
const services: ServiceEntry[] = [
  ...
  },
  {
    ...
    description:
      "Expert motion graphics and color grading that improved audience retention by 25%.",
    icon: "post",
  },
  {
    indexLabel: "03",
    ...
    description:
      "Leveraging Runway, Kling, and Sora to cut production time by 20% while increasing engagement.",
    icon: "ai",
  },
  {
    indexLabel: "04",
...
export function ServicesGlassBento({ isDark, headingClass, mutedClass, cardSurfaceClass }: ServicesGlassBentoProps) {
