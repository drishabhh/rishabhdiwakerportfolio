...
export function HeroCta({ label, href, visible, onHoverChange }: HeroCtaProps) {
  ...
  return (
    <motion.a
      ...
      className={`group mt-0 inline-flex w-fit items-center gap-1 rounded-full border border-white/45 bg-zinc-950/55 px-2 py-1.5 text-[10px] font-semibold tracking-tight text-white shadow-[0_6px_18px_rgba(0,0,0,0.68),0_14px_34px_rgba(0,0,0,0.55),0_24px_52px_rgba(0,0,0,0.4),0_36px_72px_rgba(0,0,0,0.24)] backdrop-blur-xl transition-[transform,box-shadow,background-color,border-color] duration-200 hover:-translate-y-1 hover:border-orange-400/55 hover:bg-zinc-900/65 hover:shadow-[0_10px_26px_rgba(0,0,0,0.62),0_20px_48px_rgba(0,0,0,0.48),0_32px_68px_rgba(255,77,0,0.22)] max-md:shadow-[0_6px_18px_rgba(0,0,0,0.68),0_14px_34px_rgba(0,0,0,0.55),0_24px_52px_rgba(0,0,0,0.4),0_36px_72px_rgba(0,0,0,0.24)] max-md:hover:shadow-[0_10px_26px_rgba(0,0,0,0.62),0_20px_48px_rgba(0,0,0,0.48),0_32px_68px_rgba(255,77,0,0.22)] tall:gap-3 tall:border-white/30 tall:bg-white/10 tall:px-6 tall:py-3 tall:text-[0.9375rem] tall:tracking-wide tall:hover:bg-orange-500/20 md:gap-3 md:border-white/30 md:bg-white/10 md:px-6 md:py-3 md:text-[0.9375rem] md:tracking-wide md:shadow-[0_10px_36px_rgba(0,0,0,0.28)] md:hover:bg-orange-500/20 md:hover:shadow-[0_14px_44px_rgba(255,77,0,0.38)] ${visible ? "pointer-events-auto" : "pointer-events-none"}`}
